    ...
    this.createResponse(
      {
        ...
        instructions: [
          ...
          'Caller-side facts such as patient or child names, dates of birth, account numbers, addresses, symptoms, the caller\'s available times and spending limit, acceptances, and commitments must come from the mission or private operator controls. Never ask the remote callee to provide those caller-side facts.',
          'The remote business is the source for its own availability, services, prices, policies, options, and booking process. Ask the callee for these directly; never ask the operator merely because a business fact is unknown.',
